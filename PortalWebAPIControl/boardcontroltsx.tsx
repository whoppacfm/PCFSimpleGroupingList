...
function Boardcontrol(props:any) {
  ...
  if(DATA_SOURCE=="CRM" && (griddata2==null || griddata2.length==0)) {
    ...
    function showLookup() {
      ...
      let viewId = "0D5D377B-5E7C-47B5-BAB1-A5CB8B4AC105";
      ...
      props.context.utils.lookupObjects(lookupOptions).then((success:any) => {
        if (success && success.length > 0) {
        // Cache the necessary information for the newly selected entity lookup
        const selectedReference = success[0];
        
        console.log("id: "+ selectedReference.id + ", name: " + selectedReference.name + ", type: " + selectedReference.entityType);
    ...
    return (
      <div className="boardControlDiv" style={boardControlInnerStyle}>
        ...
        <div className='searchcontroldiv'>
          ...
          {/*--<button type="button" onClick={showLookup}>Lookup Record</button>--*/}
        </div>
